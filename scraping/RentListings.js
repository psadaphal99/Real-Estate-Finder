...
module.exports.getRentListings = async ()=> {
    try {
        ...
        const response = await axios.put(
           ...
           //console.log("response is = ", (response.data.cat1.searchResults.listResults[5]));
        //   console.log("mapResults are = ");
           console.log("response is = ", (response.data.cat1.searchResults.mapResults[5]));
           console.log("response is = ", (response.data.cat1.searchResults.mapResults[5]).detailUrl);
           let s = (response.data.cat1.searchResults.mapResults[5]).detailUrl.split('/');
           console.log("response is = ", s[s.length-2]);
          let photoData = response.data.cat1.searchResults.listResults;
           ...
           for(let i=0; i<data.length;i++) {
            ...
            if(data[i]?.hdpData?.homeInfo?.homeType!="APARTMENT") {
        ...
        console.error("error in getting rental Listings", e);
        throw(e);
    }
}
